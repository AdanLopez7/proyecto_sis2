         ...
         //3 ejecutar SQL
          ...
          while(miResult.next())
          {
              if(miResult.getString(3).equals(campoUsuario.getText())&&miResult.getString(4).equals(campoContra.getText()))
              {
                 ...
                 InterfazEstudiante e=new InterfazEstudiante(miResult.getString(1),miResult.getString(2));
                 e.ejecutar();
                 return;
              }
         ...
         //3 ejecutar SQL
          ...
          while(miResult.next())
          {
              if(miResult.getString(3).equals(campoUsuario.getText())&&miResult.getString(4).equals(campoContra.getText()))
              {
                ...
                InterfazDocente d=new InterfazDocente(miResult.getString(1),miResult.getString(2));
                 InterfazDocente docen=new InterfazDocente(miResult.getString(5));
                 d.ejecutar();
               return; 
